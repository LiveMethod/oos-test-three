...
NOTARIZE_BUNDLE_ID=com.PalaceAudio.TestThree
NOTARIZE_BUNDLE_ID_DEMO=com.PalaceAudio.TestThree.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/TestThree.iss
#  git checkout installer/TestThree.pkgproj
